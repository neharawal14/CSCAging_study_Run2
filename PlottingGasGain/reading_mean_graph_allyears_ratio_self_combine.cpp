...
class GasGain{
  public : 
    ...
    std::pair<TGraphAsymmErrors*,TGraphAsymmErrors*> normalising_fitting(TGraphAsymmErrors* graph_original, TString chamber_name, TString year,  TGraphAsymmErrors* graph_reference) ;
    void normalising(TGraphAsymmErrors* graph_original, TString chamber_name, TString year,  TGraphAsymmErrors* graph_reference) ;
};
TGraphAsymmErrors* GasGain :: combining_different_years(std::vector<TGraphAsymmErrors*> yearly_normalised_graphs, TString chamber){
 ...
 void GasGain ::  normalising(TGraphAsymmErrors* graph_original, TString chamber_name, TString year,  TGraphAsymmErrors* graph_reference) {
...
std::pair<TGraphAsymmErrors*,TGraphAsymmErrors*> GasGain ::  normalising_fitting(TGraphAsymmErrors* graph_original, TString chamber_name, TString year,  TGraphAsymmErrors* graph_reference) {
...
void  reading_mean_graph_allyears_ratio_self_combine(TString ratio_type){
...
void GasGain:: reading_gas_gain_cumulative(){
 ...
 //end of deciding reference
   ...
   for (auto& chamber : chambers) {
      ...
      std::vector<TGraphAsymmErrors*> yearly_normalising_graphs_org;
      std::vector<TGraphAsymmErrors*> yearly_normalising_graphs_ref;
      TGraphAsymmErrors* final_normalised_histogram;
      TGraphAsymmErrors* final_normalising_histogram_org;
      TGraphAsymmErrors* final_normalising_histogram_ref;
      for (auto& year : years) {
          ...
          // Normalising gas gain wrt intlumi of final chambers with reference chamber
           this->normalising(h_intlumi_final, chamber, year,  h_reference);  
           normalised_histograms = this->normalising_fitting(h_intlumi_final, chamber, year,  h_reference);  
          ...
          yearly_normalising_graphs_org.push_back(h_intlumi_final);
          yearly_normalising_graphs_ref.push_back(h_reference);
 	  ...
 	  final_normalising_histogram_org = 	this->combining_different_years(yearly_normalising_graphs_org, chamber);
 	  final_normalising_histogram_ref = 	this->combining_different_years(yearly_normalising_graphs_ref, chamber);


    this->normalising(final_normalising_histogram_org, chamber, "run2",  final_normalising_histogram_ref);  
