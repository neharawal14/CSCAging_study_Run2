...
#ifndef gas_gain_analysis_plus_minus_h
#define gas_gain_analysis_plus_minus_h
#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
#include <TH3.h>
...
class gas_gain_analysis_plus_minus {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   gas_gain_analysis_plus_minus(TTree *tree=0);
   virtual ~gas_gain_analysis_plus_minus();
...
#ifdef gas_gain_analysis_plus_minus_cxx
gas_gain_analysis_plus_minus::gas_gain_analysis_plus_minus(TTree *tree) : fChain(0) 
{
...
gas_gain_analysis_plus_minus::~gas_gain_analysis_plus_minus()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gas_gain_analysis_plus_minus::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gas_gain_analysis_plus_minus::LoadTree(Long64_t entry)
{
...
void gas_gain_analysis_plus_minus::Setup_new_tree(){
...
void gas_gain_analysis_plus_minus::Init(TTree *tree)
{
...
Bool_t gas_gain_analysis_plus_minus::Notify()
{
...
void gas_gain_analysis_plus_minus::Show(Long64_t entry)
{
...
Int_t gas_gain_analysis_plus_minus::Cut(Long64_t entry)
{
...
#endif // #ifdef gas_gain_analysis_plus_minus_cxx
