...
dataset="C"
input_directory = "/cmsuf/data/store/user/nrawal/rootfiles_2022/SingleMuon_2022/SingleMuon/crab_SingleMuon_Run2022C-ZMu-10Dec2022-v2".format(dataset)
output_path= "/cmsuf/data/store/user/t2/users/neha.rawal/CSCAgeing_2022/ntuples_output_2022/2022C_1/"
...
log_file=open("log_2022C_1.txt","w") 
