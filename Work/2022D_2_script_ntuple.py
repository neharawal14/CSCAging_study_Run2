...
dataset="D"
input_directory = "/cmsuf/data/store/user/nrawal/rootfiles_2022/SingleMuon_2022/Muon/crab_Muon_Run2022{}-ZMu-PromptReco-v2/230124_100756/".format(dataset)
output_path= "/cmsuf/data/store/user/t2/users/neha.rawal/CSCAgeing_2022/ntuples_output_2022/2022D_2/first/"
...
log_file=open("log_2022D_2_first.txt","w") 
