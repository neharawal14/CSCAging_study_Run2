...
dataset="F"
input_directory = "/cmsuf/data/store/user/nrawal/rootfiles_2022/SingleMuon_2022/Muon/crab_Muon_Run2022{}-ZMu-PromptReco-v1/230124_100849/".format(dataset)
output_path= "/cmsuf/data/store/user/t2/users/neha.rawal/CSCAgeing_2022/ntuples_output_2022/2022F/first/"
...
log_file=open("log_2022F_first.txt","w") 
