...
#	hadd_line = "hadd {}/2022{}/csc_output_dataset_{}_{}_tree.root {}/first/*{}_tree.root {}/second/*{}_tree.root".format(output_directory,dataset,dataset,chamber_name,input_directory,chamber_name,input_directory, chamber_name)
	hadd_line = f"hadd {output_directory}/2022{dataset}/csc_output_dataset_{dataset}_{chamber_name}_tree.root {input_directory}/2022F/first/*{chamber_name}_tree.root {input_directory}/2022F/second/*{chamber_name}_tree.root {input_directory}/2022F_2/*{chamber_name}_tree.root"
	print(hadd_line)
