...
input_directory = "/cmsuf/data/store/user/t2/users/neha.rawal/CSCAgeing_2022/ntuples_output_2022/2022G"
...
for chamber_name in chamber: 
	hadd_line = "hadd {}/2022{}/csc_output_dataset_{}_{}_tree.root {}/*{}_tree.root".format(output_directory,dataset,dataset,chamber_name,input_directory,chamber_name)
	print(hadd_line)
